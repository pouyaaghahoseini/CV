...
\begin{document}
	...
	\begin{rSection}{Experience}
		\begin{rSubsection}{Lead Teaching Assistantship, Fundamentals of Programming: C Language}{Present}{Instructor: Dr.Farzaneh Saalaari}{ }
		\item Holding Weekly Workshops
		\item Designing and Evaluating Assignments
		
		\end{rSubsection}					%------------------------------------------------
		\begin{rSubsection}{Teaching Assistantship, Compilers}{Present}{Instructor: Dr.Mohammad Hassan Shirali-Shahreza}{ }
		\item Exam Preperation Classes and Assignment Evaluation
		\end{rSubsection}					%------------------------------------------------
		\begin{rSubsection}{Teaching Assistantship, Data Structures and Algorithms }{Feb 2019 - Jun 2019}{Instructor: Dr.Mohammad Akbari}{ }
			\item 
		...
		\begin{rSubsection}{Lead Teaching Assistantship, Introduction to the Theory of Computation}{Sep 2018 - Jan 2019}{Instructor: Dr.Fatemeh Zare-Mirakabad}{ }
...
%----------------------------------------------------------------------------------------	
	\begin{rSection}{Research Interests}
		...
		\begin{itemize}{\bfseries}
			...
			\item {\bfseries Bioinformatics }
			\item {\bfseries Data Science}
			\item {\bfseries Social Media Computing}
		\end{itemize}
